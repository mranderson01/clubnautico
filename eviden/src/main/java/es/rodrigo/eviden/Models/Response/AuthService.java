...
public class AuthService {
    ...
    public String login(es.rodrigo.seguridad.security.Auth.LoginRequest request){
    ...
    public String register(es.rodrigo.seguridad.security.Auth.RegisterRequest registerRequest){
